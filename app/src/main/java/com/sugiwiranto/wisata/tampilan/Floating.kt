...
import kotlinx.android.synthetic.main.wis5.*
import kotlinx.android.synthetic.main.wis5.lok

class Floating : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.wis5)

        backwis5.setOnClickListener() {
            val intent = Intent(this, DaftarWisata::class.java)
            startActivity(intent)
        }
        lok.setOnClickListener() {
            val i = Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/maps/8sjf7utcXTipyVYi9"))
            startActivity(i)
        }
    }
}